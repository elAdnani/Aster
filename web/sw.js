const CACHE='aster-v19';
const CORE=['/','/styles.css','/control-center.css','/admin-catalog.css','/account-center.css','/auth.css?v=9','/admin-flow.css?v=15','/projects.css?v=3','/app.js?v=19','/icon.svg','/manifest.webmanifest'];
