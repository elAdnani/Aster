const CACHE='aster-v23';
const CORE=['/','/styles.css','/control-center.css','/admin-catalog.css','/account-center.css','/auth.css?v=9','/admin-flow.css?v=15','/projects.css?v=3','/model-manager.css?v=1','/attachments.css?v=2','/shell.css?v=1','/bootstrap.js?v=1','/app.js?v=21','/icon.svg','/manifest.webmanifest'];
