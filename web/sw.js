...
const CORE=['/','/styles.css','/control-center.css','/admin-catalog.css','/account-center.css','/auth.css?v=9','/admin-flow.css?v=12','/app.js?v=12','/icon.svg','/manifest.webmanifest'];
