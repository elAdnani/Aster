const CACHE='aster-v17';
const CORE=['/','/styles.css','/control-center.css','/admin-catalog.css','/account-center.css','/auth.css?v=9','/admin-flow.css?v=15','/projects.css?v=1','/app.js?v=17','/icon.svg','/manifest.webmanifest'];
