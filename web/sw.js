...
const CORE=['/','/styles.css','/control-center.css','/admin-catalog.css','/account-center.css','/auth.css?v=9','/admin-flow.css?v=15','/app.js?v=15','/icon.svg','/manifest.webmanifest'];
